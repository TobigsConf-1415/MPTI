...
sherlockModel = getIntegrated("DialogRPT/restore/ensemble.yml",  'DialoGPT/output', False)
EOS = "<|endoftext|>"
...
tokenizer_ironman = GPT2Tokenizer.from_pretrained('TransferTransfo/default_gpt2')
model_ironman = GPT2LMHeadModel.from_pretrained('TransferTransfo/default_gpt2')
...
rule_based_df = pd.read_json('TransferTransfo/rule_based_df.json')
