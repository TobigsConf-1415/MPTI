...
import torch, os, pdb
import numpy as np
from DialogRPT.src.transformers19 import GPT2Tokenizer, GPT2Model, GPT2Config
from DialogRPT.src.shared import EOS_token
...
class Scorer(ScorerBase):
    ...
    def load(self, path):
        from DialogRPT.src.shared import download_model
        download_model(path)
